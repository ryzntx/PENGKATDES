            ...
            <li class="nav-item dropdown no-arrow">
                <div class="nav-item dropdown no-arrow">
                    <a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><img
                            class="border rounded-circle img-profile" src="assets/img/avatars/avatar1.jpeg"><span
                            class="text-body-emphasis d-none d-lg-inline ms-2 small"><?= session('nama') ?></span></a>
                    <div class="dropdown-menu shadow dropdown-menu-end animated--grow-in">
                        <h6 class="dropdown-header d-flex align-items-center">
                            <!-- <img class="dropdown-user-img" src="assets/img/illustrations/profiles/profile-1.png"> -->
                            <div class="dropdown-user-details">
                                <div class="dropdown-user-details-name"><?= session('nama') ?></div>
                                <div class="dropdown-user-details-email"><?= session('username') ?></div>
                            </div>
                        </h6>
