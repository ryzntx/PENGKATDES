...
<div class="container-fluid">
    ...
    <?php endif; ?>
    <div class="card">
        <div class="card-header">Ubah Data Organisasi</div>
        <form action="<?= base_url('admin/organisasiDesa/ubah/' . $data->id) ?>" method="post"
            enctype="multipart/form-data">

            <div class="card-body">
                <div class="form-group">
                    <label for="" class="form-label">NIP</label>
                    <input type="text" class="form-control <?= (session('errors.nip')) ? 'is_invalid' : '' ?>"
                        name="nip" id="nip" placeholder="Masukkan NIP" value="<?= $data->nip ?? old('nip') ?>" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control <?= (session('errors.nama')) ? 'is_invalid' : '' ?>"
                        name="nama" id="nama" placeholder="Masukkan Nama" value="<?= $data->nama ?? old('nama') ?>"
                        required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control <?= (session('errors.jabatan')) ? 'is_invalid' : '' ?>"
                        name="jabatan" id="jabatan" placeholder="Masukkan Jabatan"
                        value="<?= $data->jabatan ?? old('jabatan') ?>" required>
                ...
                <div class="form-group">
                    ...
                    <input type="file" class="form-control <?= (session('errors.foto')) ? 'is_invalid' : '' ?>"
